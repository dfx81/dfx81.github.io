...
function showPolicy(){
    let str = ""
       ...
       str += "5. By agreeing to this, the user agrees that they're not responsible with their personal data and will freely give them out to other parties such as this our obvious trap website.\n";
